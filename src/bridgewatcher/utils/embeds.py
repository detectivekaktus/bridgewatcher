...
from bridgewatcher.utils.formatting import format_name


class NameErrorEmbed(Embed):
    def __init__(self, name: str) -> None:
        super().__init__(
            title=f"🔴 {format_name(name)} doesn't exist!",
...
class OutdatedDataErrorEmbed(Embed):
    def __init__(self) -> None:
        super().__init__(
            title="🔴 The data on the server is outdated!",
